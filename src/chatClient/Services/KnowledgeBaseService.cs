    ...
    public class KnowledgeBaseService
    {
        ...
        private void LoadKnowledgeBases()
        {
            ...
            if (File.Exists(configFile))
            {
                ...
                _knowledgeBases = JsonSerializer.Deserialize<List<KnowledgeBase>>(json) ?? new List<KnowledgeBase>();
            }
            else
            {
        ...
        {
            string configFile = Path.Combine(_knowledgeBasePath, "knowledge_bases.json");
            string json = JsonSerializer.Serialize(_knowledgeBases, new JsonSerializerOptions { WriteIndented = true });
